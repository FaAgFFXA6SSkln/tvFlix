 ...
 */
!function(t, e) {
    "object" === typeof exports && "undefined" !== typeof module ? module.exports = e() : "function" == typeof define && define.amd ? (t.Artplayer = e(),
    define(function() {
        return t.Artplayer
    ...
    function R(t) {
        ...
        for (; r; )
            e.push(r),
            r = r.parentNode;
        return e.includes(window) || void 0 === window || e.push(window),
        e
    }
    ...
    class dt {
        ...
        add(t) {
            ...
            _(!this.cache.has(r), `Can't add an existing [${r}] to the [${this.name}]`),
            this.id += 1;
            const a = L("div");
            f(a, `art-${this.name}`),
            f(a, `art-${this.name}-${r}`);
            ...
            i ? i.insertAdjacentElement("beforebegin", a) : y(this.$parent, a),
            e.html && y(a, e.html),
            e.style && x(a, e.style),
            e.tooltip && T(a, e.tooltip);
            const s = [];
            if (e.click) {
            ...
            return e.selector && ["left", "right"].includes(e.position) && this.selector(e, a, s),
            this[r] = a,
            this.cache.set(r, {
                $ref: a,
                events: s,
            ...
            e.mounted && e.mounted.call(this.art, a),
            a
        }
        remove(t) {
    ...
    class pt extends dt {
        ...
        init() {
            ...
            t.playbackRate && this.add(function(t) {
                return e => {
                    const {i18n: r, constructor: {PLAYBACK_RATE: a}} = e
                      , o = a.map(t => `<span data-value="${t}">${1 === t ? r.get("Normal") : t.toFixed(1)}</span>`).join("");
                    return {
                        ...t,
            ...
            t.aspectRatio && this.add(function(t) {
                return e => {
                    const {i18n: r, constructor: {ASPECT_RATIO: a}} = e
                      , o = a.map(t => `<span data-value="${t}">${"default" === t ? r.get("Default") : t}</span>`).join("");
                    return {
                        ...t,
            ...
            t.flip && this.add(function(t) {
                return e => {
                    const {i18n: r, constructor: {FLIP: a}} = e
                      , o = a.map(t => `<span data-value="${t}">${r.get(N(t))}</span>`).join("");
                    return {
                        ...t,
            ...
            for (let o = 0; o < t.contextmenu.length; o++)
                this.add(t.contextmenu[o]);
            e(r, "contextmenu", t => {
                ...
                const e = t.clientX
                  , o = t.clientY
                  , {height: n, width: i, left: s, top: l} = P(r)
                  , {height: c, width: d} = P(a);
                let p = e - s
                  , h = o - l;
                e + d > s + i && (p = i - d),
                o + c > l + n && (h = n - c),
    ...
    function ht(t, e) {
        const {$progress: r} = t.template
          , {left: a} = P(r)
          , o = D((p ? e.touches[0].clientX : e.clientX) - a, 0, r.clientWidth)
          , n = o / r.clientWidth * t.duration;
        return {
            second: n,
            time: F(n),
            width: o,
    ...
    function ut(t, e) {
        if (t.isRotate) {
            const r = e.touches[0].clientY / t.height
              , a = r * t.duration;
            t.emit("setBar", "played", r, e),
            t.seek = a
        } else {
            const {second: r, percentage: a} = ht(t, e);
    ...
    function mt(t) {
        return e => {
            const {icons: r, option: a, proxy: o} = e
              , {$player: n, $progress: i} = e.template;
            return {
                ...t,
                ...
                mounted: t => {
                    ...
                    r.indicator ? y(v, r.indicator) : w(v, "backgroundColor", "var(--art-theme)"),
                    e.on("setBar", function(r, a, o) {
                        const i = "played" === r && o && p;
                        if ("loaded" === r && w(d, "width", 100 * a + "%"),
                        "hover" === r && (w(c, "width", 100 * a + "%"),
                        C(o, m) ? function(r) {
                            const {width: a} = ht(e, r)
                        ...
                        0 === a ? g(n, "art-progress-hover") : f(n, "art-progress-hover")),
                        "played" === r && (w(h, "width", 100 * a + "%"),
                        w(v, "left", 100 * a + "%")),
                        i) {
                    ...
                    e.emit("setBar", "loaded", e.loaded || 0),
                    p || (o(i, "click", t => {
                        t.target !== v && ut(e, t)
                    }
                    ),
                    o(i, "mousemove", t => {
                        const {percentage: r} = ht(e, t);
                    ...
                    e.on("document:mousemove", t => {
                        if (l) {
                            const {second: r, percentage: a} = ht(e, t);
    ...
    class ft extends dt {
        constructor(t) {
            ...
            t.on("control", t => {
                t ? (g(r, "art-hide-cursor"),
                f(r, "art-hover"),
                this.timer = Date.now()) : (f(r, "art-hide-cursor"),
                g(r, "art-hover"))
            }
            ),
            this.init()
        ...
        init() {
            ...
            this.add(function(t) {
                return e => ({
                    ...t,
                    mounted: t => {
                        const {proxy: r, icons: a, i18n: o} = e
                          , n = y(t, a.play)
                          , i = y(t, a.pause);
                        function s() {
                            w(n, "display", "flex"),
            ...
            this.add(function(t) {
                return e => ({
                    ...t,
                    mounted: t => {
                        const {proxy: r, icons: a} = e
                          , o = y(t, a.volume)
                          , n = y(t, a.volumeClose)
                          , i = y(t, '<div class="art-volume-panel"></div>')
                          , s = y(i, '<div class="art-volume-inner"></div>')
                          , l = y(s, '<div class="art-volume-val"></div>')
                          , c = y(s, '<div class="art-volume-slider"></div>')
                          , d = y(c, '<div class="art-volume-handle"></div>')
                          , h = y(d, '<div class="art-volume-loaded"></div>')
                          , u = y(c, '<div class="art-volume-indicator"></div>');
                        function m(t) {
                            const {top: e, height: r} = P(c);
                        ...
                        function f() {
                            if (e.muted || 0 === e.volume)
                                ...
                                w(u, "top", 100 - t + "%"),
                                w(h, "top", 100 - t + "%"),
                                l.textContent = Math.floor(t)
                            }
                        }
                        if (f(),
                        e.on("video:volumechange", f),
                        r(o, "click", () => {
                            e.muted = !0
                        }
                        ),
            ...
            t.fullscreenWeb && this.add(function(t) {
                return e => ({
                    ...
                    mounted: t => {
                        const {proxy: r, icons: a, i18n: o} = e
                          , n = y(t, a.fullscreenWebOn)
                          , i = y(t, a.fullscreenWebOff);
                        w(i, "display", "none"),
                        r(t, "click", () => {
                        ...
                        e.on("fullscreenWeb", e => {
                            e ? (T(t, o.get("Exit Web Fullscreen")),
                            w(n, "display", "none"),
                            w(i, "display", "inline-flex")) : (T(t, o.get("Web Fullscreen")),
                            w(n, "display", "inline-flex"),
                            w(i, "display", "none"))
                        }
                        )
                    }
            ...
            t.fullscreen && this.add(function(t) {
                return e => ({
                    ...
                    mounted: t => {
                        const {proxy: r, icons: a, i18n: o} = e
                          , n = y(t, a.fullscreenOn)
                          , i = y(t, a.fullscreenOff);
                        w(i, "display", "none"),
                        r(t, "click", () => {
                        ...
                        e.on("fullscreen", e => {
                            e ? (T(t, o.get("Exit Fullscreen")),
                            w(n, "display", "none"),
                            w(i, "display", "inline-flex")) : (T(t, o.get("Fullscreen")),
                            w(n, "display", "inline-flex"),
                            w(i, "display", "none"))
                        }
                        )
        ...
        check(t) {
            if (t) {
                ...
                for (let e = 0; e < t.$control_option.length; e++) {
                    ...
                    r.default = r === t,
                    r.default && $(r.$control_item, "art-current")
                }
            }
        }
        selector(t, e, r) {
            const {proxy: a} = this.art.events;
            f(e, "art-control-selector");
            const o = L("div");
            f(o, "art-selector-value"),
            y(o, t.html),
            e.textContent = "",
            y(e, o);
            const n = L("div");
            f(n, "art-selector-list"),
            y(e, n);
            for (let s = 0; s < t.selector.length; s++) {
                const e = t.selector[s]
                  , r = L("div");
                f(r, "art-selector-item"),
                e.default && f(r, "art-current"),
                r.dataset.index = s,
            ...
            const i = a(n, "click", async e => {
                ...
                this.check(a),
                t.onSelect && (o.innerHTML = await t.onSelect.call(this.art, a, a.$control_item, e))
            }
            );
            r.push(i)
        }
    ...
    class vt {
        constructor(t) {
            ...
            function(t, e) {
                const {constructor: r, template: {$player: a, $video: o}} = t;
                function n(e) {
                    C(e, a) ? (t.isInput = "INPUT" === e.target.tagName,
                    t.isFocus = !0,
                    t.emit("focus", e)) : (t.isInput = !1,
                    t.isFocus = !1,
                    t.emit("blur", e))
                }
                t.on("document:click", n),
                t.on("document:contextmenu", n);
                let i = [];
                e.proxy(o, "click", e => {
                    const a = Date.now();
                    i.push(a);
                    const {MOBILE_CLICK_PLAY: o, DBCLICK_TIME: n, MOBILE_DBCLICK_PLAY: s, DBCLICK_FULLSCREEN: l} = r
                      , c = i.filter(t => a - t <= n);
                    switch (c.length) {
                    case 1:
                        t.emit("click", e),
                        p ? !t.isLock && o && t.toggle() : t.toggle(),
                        i = c;
                        break;
                    case 2:
                        t.emit("dblclick", e),
                        p ? !t.isLock && s && t.toggle() : l && (t.fullscreen = !t.fullscreen),
                        i = [];
                        break;
                    default:
                        i = []
            ...
            function(t, e) {
                const {option: r, constructor: a} = t;
                t.on("resize", () => {
                ...
                t.on("window:orientationchange", () => o()),
                t.on("window:resize", () => o()),
                screen && screen.orientation && screen.orientation.onchange && e.proxy(screen.orientation, "change", () => o())
            }(t, this),
            function(t, e) {
                if (p && !t.option.isLive) {
                    const {$video: r, $progress: a} = t.template;
                    let o = null
                      , n = !1
                      , i = 0
                      , s = 0
                    ...
                    const c = e => {
                        if (1 === e.touches.length && !t.isLock) {
                            o === a && ut(t, e),
                            n = !0;
                            const {pageX: r, pageY: c} = e.touches[0];
                            i = r,
                            s = c,
                            l = t.currentTime
                        }
                      ...
                      , d = e => {
                        if (1 === e.touches.length && n && t.duration) {
                            const {pageX: a, pageY: n} = e.touches[0]
                              , c = gt(i, s, a, n)
                              , d = [3, 4].includes(c)
                              , p = [1, 2].includes(c);
                            if (d && !t.isRotate || p && t.isRotate) {
                                ...
                                t.seek = u,
                                t.emit("setBar", "played", D(u / t.duration, 0, 1), e),
                                t.notice.show = `${F(u)} / ${F(t.duration)}`
                            }
                        }
                    }
                      , p = () => {
                    ...
                    e.proxy(r, "touchmove", d)),
                    e.proxy(a, "touchstart", t => {
                        o = a,
                        c(t)
                    }
                    ),
                    e.proxy(a, "touchmove", d),
                    t.on("document:touchend", p)
                }
            }(t, this),
            function(t) {
                const {option: e, constructor: r, template: {$container: a}} = t
                  , o = Q( () => {
                    t.emit("view", E(a, r.SCROLL_GAP))
                }
                , r.SCROLL_TIME);
                t.on("window:scroll", () => o()),
                t.on("view", r => {
                    e.autoMini && (t.mini = !r)
                }
                )
        ...
        proxy(t, e, r, a={}) {
            ...
            return this.destroyEvents.add(o),
            o
        }
        hover(t, e, r) {
        ...
        destroy() {
            for (const e of this.destroyEvents)
                try {
                    e()
                } catch (t) {
    ...
    class yt {
        ...
        add(t, e) {
            return this.keys[t] ? this.keys[t].includes(e) || this.keys[t].push(e) : this.keys[t] = [e],
            this
        }
        remove(t, e) {
            if (this.keys[t]) {
                ...
                0 === this.keys[t].length && delete this.keys[t]
            }
            return this
        }
    }
    ...
    class wt {
        ...
        update(t) {
            this.languages = q(this.languages, t),
            this.init()
        }
    }
    class xt {
    ...
    class kt extends dt {
        ...
        init() {
            const {proxy: t, constructor: e, template: {$infoPanel: r, $infoClose: a, $video: o}} = this.art;
            t(a, "click", () => {
                this.show = !1
            }
            );
    ...
    class Tt extends dt {
        constructor(t) {
            super(t),
            this.name = "loading",
            y(t.template.$loading, t.icons.loading)
        }
    }
    class Et extends dt {
        constructor(t) {
    ...
    class Ct {
        ...
        set show(t) {
            const {constructor: e, template: {$player: r, $noticeInner: a}} = this.art;
            t ? (a.textContent = t instanceof Error ? t.message.trim() : t,
            f(r, "art-notice-show"),
        ...
        get show() {
            const {template: {$player: t}} = this.art;
    ...
    function It(t) {
        ...
        t.once("video:loadedmetadata", () => {
            ...
            Mt.isEnabled ? (n = t,
            Mt.on("change", () => {
                n.emit("fullscreen", Mt.isFullscreen),
                Mt.isFullscreen ? (n.state = "fullscreen",
                f(o, "art-fullscreen")) : g(o, "art-fullscreen"),
                n.emit("resize")
            }
            ),
            Mt.on("error", t => {
            ...
            H(n, "fullscreen", {
                ...
                t.on("document:webkitfullscreenchange", () => {
                    t.emit("fullscreen", t.fullscreen),
                    t.emit("resize")
                }
                ),
                H(t, "fullscreen", {
    ...
    function Pt(t) {
        const {icons: e, proxy: r, storage: a, template: {$player: o, $video: n}} = t;
        let i = !1
          , s = 0
          , l = 0;
        function c() {
        ...
        function d(e, r) {
            t.playing ? (w(e, "display", "none"),
            w(r, "display", "flex")) : (w(e, "display", "flex"),
            w(r, "display", "none"))
        }
        function p() {
            const {$mini: e} = t.template
                    ...
                    const h = function() {
                            ...
                            w(o, "display", "flex");
                        {
                            ...
                            const h = y(o, '<div class="art-mini-state"></div>')
                              , u = y(h, e.play)
                              , m = y(h, e.pause);
                            return r(u, "click", () => t.play()),
                            r(m, "click", () => t.pause()),
                            d(u, m),
                            t.on("video:playing", () => d(u, m)),
                            t.on("video:pause", () => d(u, m)),
                            t.on("video:timeupdate", () => d(u, m)),
                            r(o, "mousedown", t => {
                                i = 0 === t.button,
                                s = t.pageX,
                                l = t.pageY
                      ...
                      , u = a.get("top")
                      , m = a.get("left");
                    "number" === typeof u && "number" === typeof m ? (w(h, "top", `${u}px`),
                    w(h, "left", `${m}px`),
                    E(h) || p()) : p(),
                    t.emit("mini", !0)
                } else
    ...
    function At(t) {
        const {i18n: e, notice: r, template: {$video: a}} = t;
        document.pictureInPictureEnabled ? function(t) {
            const {template: {$video: e}, proxy: r, notice: a} = t;
    ...
    function Rt(t) {
        const {option: e, template: {$progress: r, $video: a}} = t;
        let o = null
          , n = !1
          , i = null;
        t.on("setBar", async (o, s, l) => {
            const c = t.controls?.thumbnails
              , {url: d, scale: h} = e.thumbnails;
            if (!c || !d)
                return;
            if ("hover" === o || "played" === o && l && p) {
                ...
                o > 0 && o < r.clientWidth && function(o) {
                    ...
                    if (!n)
                        return;
                    const {number: s, column: l, width: c, height: d, scale: p} = e.thumbnails
                      , h = c * p || i.naturalWidth / l
                      , u = d * p || h / (a.videoWidth / a.videoHeight)
                      , m = r.clientWidth / s
                      , f = Math.floor(o / m)
                      , g = Math.ceil(f / l) - 1
                      , v = f % l || l - 1;
                    w(n, "backgroundImage", `url(${i.src})`),
                    w(n, "height", `${u}px`),
                    w(n, "width", `${h}px`),
                    w(n, "backgroundPosition", `-${v * h}px -${g * u}px`),
                    o <= h / 2 ? w(n, "left", 0) : o > r.clientWidth - h / 2 ? w(n, "left", r.clientWidth - h + "px") : w(n, "left", o - h / 2 + "px")
                }(o)
            }
        }
        ),
        H(t, "thumbnails", {
            ...
            set(e) {
                e.url && !t.option.isLive && (t.option.thumbnails = e,
                clearTimeout(o),
                o = null,
                n = !1,
                i = null)
    ...
    class Ot {
        constructor(t) {
                ...
                H(t, "url", {
                    ...
                    async set(a) {
                        if (a) {
                            ...
                            n && i ? (await Z(),
                            t.loading.show = !0,
                            i.call(t, r, a, t)) : (URL.revokeObjectURL(o),
                            r.src = a),
                            o !== t.url && (t.option.url = a,
                            t.isReady && o && t.once("video:canplay", () => {
                                t.emit("restart", a)
                            }
                            ))
                        } else
            ...
            function(t) {
                const {i18n: e, notice: r, option: a, constructor: {instances: o}, template: {$video: n}} = t;
                H(t, "play", {
                    async value() {
            ...
            function(t) {
                const {template: {$video: e}, i18n: r, notice: a} = t;
                H(t, "pause", {
                    value() {
                        const o = e.pause();
            ...
            function(t) {
                ...
                H(t, "seek", {
                    set(r) {
                        t.currentTime = r,
                        t.duration && (e.show = `${F(t.currentTime)} / ${F(t.duration)}`),
                        t.emit("seek", t.currentTime, r)
                    }
                }),
                H(t, "forward", {
                    set(e) {
            ...
            function(t) {
                const {template: {$video: e}, i18n: r, notice: a, storage: o} = t;
                H(t, "volume", {
                    get: () => e.volume || 0,
                    set: t => {
                        e.volume = D(t, 0, 1),
                        a.show = `${r.get("Volume")}: ${Number.parseInt(100 * e.volume, 10)}`,
                        0 !== e.volume && o.set("volume", e.volume)
                    }
                }),
                H(t, "muted", {
                    get: () => e.muted,
            ...
            function(t) {
                ...
                H(t, "currentTime", {
                    ...
                    set: r => {
                        ...
                        Number.isNaN(r) || (e.currentTime = D(r, 0, t.duration))
                    }
                })
            }(t),
            function(t) {
            ...
            function(t) {
                function e(e, r) {
                    return new Promise( (a, o) => {
                        ...
                        const l = {
                            error: e => {
                                t.off("video:canplay", l.canplay),
                                t.off("video:loadedmetadata", l.metadata),
                                o(e)
                            }
                            ,
                            metadata: () => {
                        ...
                        t.once("video:error", l.error),
                        t.once("video:loadedmetadata", l.metadata),
                        t.once("video:canplay", l.canplay)
                    }
                    )
                }
                H(t, "switchQuality", {
                    ...
                    set(o) {
                        if (o) {
                            if (o === e.playbackRate)
                                return;
                            e.playbackRate = o,
                            a.show = `${r.get("Rate")}: ${1 === o ? r.get("Normal") : `${o}x`}`
                        } else
                            t.playbackRate = 1
                    }
                })
                    ...
                    set(n) {
                        ...
                        "default" === n)
                            ...
                            const t = n.split(":").map(Number)
                              , {clientWidth: e, clientHeight: r} = o
                              , i = e / r
                              , s = t[0] / t[1];
                            i > s ? (w(a, "width", s * r + "px"),
                            w(a, "height", "100%"),
                            w(a, "margin", "0 auto")) : (w(a, "width", "100%"),
                            w(a, "height", e / s + "px"),
                            w(a, "margin", "auto 0")),
                            o.dataset.aspectRatio = n
                        }
                        r.show = `${e.get("Aspect Ratio")}: ${"default" === n ? e.get("Default") : n}`,
                        t.emit("aspectRatio", n)
                    }
                })
            }(t),
            function(t) {
                ...
                H(t, "screenshot", {
                    value: async e => {
                        ...
                        return Y(a, `${e || `artplayer_${F(r.currentTime)}`}.png`),
                        t.emit("screenshot", a),
                        a
                    }
                })
            ...
            It(t),
            function(t) {
                const {constructor: e, template: {$container: r, $player: a}} = t;
                let o = "";
                H(t, "fullscreenWeb", {
                    get: () => v(a, "art-fullscreen-web"),
                    set(n) {
                        n ? (o = a.style.cssText,
                        e.FULLSCREEN_WEB_IN_BODY && y(document.body, a),
                        t.state = "fullscreenWeb",
                        w(a, "width", "100%"),
                        w(a, "height", "100%"),
                        f(a, "art-fullscreen-web"),
                        t.emit("fullscreenWeb", !0)) : (e.FULLSCREEN_WEB_IN_BODY && y(r, a),
                        o && (a.style.cssText = o,
                        o = ""),
                        g(a, "art-fullscreen-web"),
            ...
            function(t) {
                const {$container: e, $player: r, $video: a} = t.template;
                H(t, "autoSize", {
                    value() {
                        const {videoWidth: o, videoHeight: n} = a
                          , {width: i, height: s} = P(e)
                          , l = o / n;
                        if (i / s > l)
                            w(r, "width", s * l / i * 100 + "%"),
                            w(r, "height", "100%");
            ...
            function(t) {
                const {template: {$player: e}, i18n: r, notice: a} = t;
                H(t, "flip", {
                    get: () => e.dataset.flip || "normal",
                    set(o) {
                        o || (o = "normal"),
                        "normal" === o ? delete e.dataset.flip : e.dataset.flip = o,
                        a.show = `${r.get("Video Flip")}: ${r.get(N(o))}`,
                        t.emit("flip", o)
                    }
                })
            }(t),
            ...
            function(t) {
                const {notice: e, i18n: r, template: a} = t;
                H(t, "subtitleOffset", {
                    get: () => a.$track?.offset || 0,
                    set(o) {
                        const {cues: n} = t.subtitle;
                        ...
                        for (let e = 0; e < n.length; e++) {
                            ...
                            r.startTime = D(r.originalStartTime + i, 0, t.duration),
                            r.endTime = D(r.originalEndTime + i, 0, t.duration)
                        }
                        t.subtitle.update(),
                        e.show = `${r.get("Subtitle Offset")}: ${o}s`,
                        t.emit("subtitleOffset", o)
                    }
                })
            }(t),
            function(t) {
                const {i18n: e, notice: r, proxy: a, template: {$video: o}} = t;
                let n = !0;
                ...
                H(t, "airplay", {
                    value() {
                        n ? (o.webkitShowPlaybackTargetPicker(),
                ...
                H(t, "quality", {
                    set(e) {
                        ...
                        r.update({
                            ...
                            html: n?.html || "",
                            selector: e,
                            onSelect: async e => (await t.switchQuality(e.url),
            ...
            Rt(t),
            function(t) {
                const {i18n: e, notice: r, option: a, constructor: o, proxy: n, template: {$player: s, $video: l, $poster: c}} = t;
                let d = 0;
                for (let p = 0; p < i.events.length; p++)
                    n(l, i.events[p], e => {
                ...
                t.on("video:error", async n => {
                    d < o.RECONNECT_TIME_MAX ? (await Z(o.RECONNECT_SLEEP_TIME),
                    d += 1,
                    t.url = a.url,
                    r.show = `${e.get("Reconnect")}: ${d}`,
                    t.emit("error", n, d)) : (t.mask.show = !0,
                    t.loading.show = !1,
                    t.controls.show = !0,
                    f(s, "art-error"),
                    await Z(o.RECONNECT_SLEEP_TIME),
            ...
            function(t) {
                const {option: e, storage: r, template: {$video: a, $poster: o}} = t;
                for (const i in e.moreVideoAttr)
                    t.attr(i, e.moreVideoAttr[i]);
                e.muted && (t.muted = e.muted),
                e.volume && (a.volume = D(e.volume, 0, 1));
                const n = r.get("volume");
                "number" === typeof n && (a.volume = D(n, 0, 1)),
                e.poster && w(o, "backgroundImage", `url(${e.poster})`),
                e.autoplay && (a.autoplay = e.autoplay),
                e.playsInline && (a.playsInline = !0,
                a["webkit-playsinline"] = !0),
                e.theme && (e.cssVar["--art-theme"] = e.theme);
                for (const i in e.cssVar)
                    t.cssVar(i, e.cssVar[i]);
                t.url = e.url
            }(t)
        }
    }
    function _t(t) {
        const {notice: e, constructor: r, template: {$player: a, $video: o}} = t
          , n = "art-auto-orientation"
          , i = "art-auto-orientation-fullscreen";
        let s = !1;
        function l() {
            const {videoWidth: t, videoHeight: e} = o
                ...
                if (l()) {
                    ...
                    setTimeout( () => {
                        t.fullscreenWeb && !v(a, n) && function() {
                            ...
                            w(a, "width", `${r}px`),
                            w(a, "height", `${e}px`),
                            w(a, "transform-origin", "0 0"),
                            w(a, "transform", `rotate(90deg) translate(0, -${e}px)`),
                            f(a, n),
                            t.isRotate = !0,
                            t.emit("resize")
                        }()
    ...
    function Vt(t) {
        const {i18n: e, icons: r, storage: a, constructor: o, proxy: n, template: {$poster: i}} = t
          , s = t.layers.add({
            name: "auto-playback",
            html: '\n            <div class="art-auto-playback-close"></div>\n            <div class="art-auto-playback-last"></div>\n            <div class="art-auto-playback-jump"></div>\n        '
        })
          , l = u(".art-auto-playback-last", s)
          , c = u(".art-auto-playback-jump", s)
          , d = u(".art-auto-playback-close", s);
        y(d, r.close);
        let p = null;
        function h() {
            ...
            clearTimeout(p),
            w(s, "display", "none"),
            r && r >= o.AUTO_PLAYBACK_MIN && (w(s, "display", "flex"),
            l.textContent = `${e.get("Last Seen")} ${F(r)}`,
            c.textContent = e.get("Jump Play"),
            n(d, "click", () => {
                w(s, "display", "none")
            }
            ),
        ...
        return t.on("video:timeupdate", () => {
            if (t.playing) {
                const e = a.get("times") || {}
                  , r = Object.keys(e);
                r.length > o.AUTO_PLAYBACK_MAX && delete e[r[0]],
    ...
    function Yt(t) {
        const {constructor: e, proxy: r, template: {$player: a, $video: o}} = t;
        let n = null
          , i = !1
          , s = 1;
        const l = () => {
        ...
        return r(o, "touchstart", r => {
            1 === r.touches.length && t.playing && !t.isLock && (n = setTimeout( () => {
                ...
                f(a, "art-fast-forward")
            }
            , e.FAST_FORWARD_TIME))
        }
        ),
        t.on("document:touchmove", l),
        t.on("document:touchend", l),
        {
            name: "fastForward",
            get state() {
    ...
    function Dt(t) {
        const {layers: e, icons: r, template: {$player: a}} = t;
        function o() {
            return v(a, "art-lock")
        }
        function n() {
        ...
        return e.add({
            ...
            mounted(e) {
                ...
                w(a, "display", "none"),
                t.on("lock", t => {
                    t ? (w(a, "display", "inline-flex"),
                    w(o, "display", "none")) : (w(a, "display", "none"),
                    w(o, "display", "inline-flex"))
                }
                )
            },
            click() {
    ...
    class Ft {
        constructor(t) {
            ...
            this.id = 0;
            const {option: e} = t;
            e.miniProgressBar && !e.isLive && this.add(Nt),
            e.lock && p && this.add(Dt),
            e.autoPlayback && !e.isLive && this.add(Vt),
            e.autoOrientation && p && this.add(_t),
            e.fastForward && p && !e.isLive && this.add(Yt);
            for (let r = 0; r < e.plugins.length; r++)
                this.add(e.plugins[r])
        }
        add(t) {
            this.id += 1;
        ...
        next(t, e) {
            ...
            return _(!j(this, r), `Cannot add a plugin that already has the same name: ${r}`),
            H(this, r, {
                value: e
            }),
            this
    ...
    class Bt extends dt {
        constructor(t) {
            ...
            this.active = null,
            this.cache = new Map,
            this.option = [...this.builtin, ...e.settings],
            e.setting && (this.format(),
            this.render(),
            t.on("blur", () => {
        ...
        get builtin() {
            ...
            return e.playbackRate && t.push(function(t) {
                const {i18n: e, icons: r, constructor: {SETTING_ITEM_WIDTH: a, PLAYBACK_RATE: o}} = t;
                function n(t) {
                ...
                return {
                    ...
                    mounted: () => {
                        i(),
                        t.on("video:ratechange", () => i())
                    }
                }
            }(this.art)),
            e.aspectRatio && t.push(function(t) {
                const {i18n: e, icons: r, constructor: {SETTING_ITEM_WIDTH: a, ASPECT_RATIO: o}} = t;
                function n(t) {
            ...
            e.flip && t.push(function(t) {
                const {i18n: e, icons: r, constructor: {SETTING_ITEM_WIDTH: a, FLIP: o}} = t;
                function n(t) {
                    return e.get(N(t))
                }
                function i() {
            ...
            e.subtitleOffset && t.push(function(t) {
                ...
                return {
                    ...
                    tooltip: "0s",
                    range: [0, -10, 10, .1],
                    onChange: e => (t.subtitleOffset = e.range[0],
                    `${e.range[0]}s`),
                    mounted: (e, r) => {
        ...
        traverse(t, e=this.option) {
            for (let r = 0; r < e.length; r++) {
                const a = e[r];
                t(a),
                a.selector?.length && this.traverse(t, a.selector)
            }
        }
        check(t) {
            t && (t.$parent.tooltip = t.html,
            this.traverse(e => {
                e.default = e === t,
                e.default && e.$item && $(e.$item, "art-current")
            }
            , t.$option),
            this.render(t.$parents))
        }
        format(t=this.option, e, r, a=[]) {
            for (let o = 0; o < t.length; o++) {
                const n = t[o];
                if (n?.name ? (_(!a.includes(n.name), `The [${n.name}] already exists in [setting]`),
                a.push(n.name)) : n.name = "setting-" + this.id++,
                !n.$formatted) {
                    H(n, "$parent", {
                        get: () => e
                    }),
        ...
        resize() {
            const {controls: t, constructor: {SETTING_WIDTH: e, SETTING_ITEM_HEIGHT: r}, template: {$player: a, $setting: o}} = this.art;
            if (t.setting && this.show) {
                const n = this.active[0]?.$parent?.width || e
                  , {left: i, width: s} = P(t.setting)
                  , {left: l, width: c} = P(a)
                  , d = i - l + s / 2 - n / 2;
                if (w(o, "height", `${this.active === this.option ? this.active.length * r : (this.active.length + 1) * r}px`),
                w(o, "width", `${n}px`),
                this.art.isRotate || p)
                    return;
                d + n > c ? (w(o, "left", null),
                w(o, "right", null)) : (w(o, "left", `${d}px`),
                w(o, "right", "auto"))
            }
        }
        inactivate(t) {
        ...
        createItem(t, e=!1) {
            ...
            j(t, "switch") && (o = "switch"),
            j(t, "range") && (o = "range"),
            j(t, "onClick") && (o = "button");
            const {icons: n, proxy: i, constructor: s} = this.art
              , l = L("div");
            f(l, "art-setting-item"),
            w(l, "height", `${s.SETTING_ITEM_HEIGHT}px`),
            l.dataset.name = t.name || "",
            l.dataset.value = t.value || "";
            const c = y(l, '<div class="art-setting-item-left"></div>')
              , d = y(l, '<div class="art-setting-item-right"></div>')
              , p = L("div");
            switch (f(p, "art-setting-item-left-icon"),
            o) {
            case "button":
            case "switch":
            case "range":
            ...
            const h = L("div");
            f(h, "art-setting-item-left-text"),
            y(h, t.html || ""),
            y(c, h),
            H(t, "$html", {
                configurable: !0,
            ...
            const u = L("div");
            switch (f(u, "art-setting-item-right-tooltip"),
            y(u, t.tooltip || ""),
            y(d, u),
            H(t, "$tooltip", {
                configurable: !0,
            ...
            case "switch":
                {
                    ...
                    H(t, "switch", {
                        ...
                        set(t) {
                            o = t,
                            t ? (w(a, "display", "none"),
                            w(r, "display", null)) : (w(a, "display", null),
                            w(r, "display", "none"))
                        }
                    });
                    break
            ...
            case "selector":
                if (t.selector?.length) {
                    const t = L("div");
                    f(t, "art-setting-item-right-icon"),
                    y(t, n.arrowRight),
                    y(d, t)
                }
            }
                ...
                if (t.$range) {
                    if (t.onRange) {
                        const e = i(t.$range, "change", async e => {
                            t.range[0] = t.$range.valueAsNumber,
                            t.tooltip = await t.onRange.call(this.art, t, l, e)
                        }
                        );
                        t.$events.push(e)
                    }
                    if (t.onChange) {
                        const e = i(t.$range, "input", async e => {
                            t.range[0] = t.$range.valueAsNumber,
                            t.tooltip = await t.onChange.call(this.art, t, l, e)
                        }
                        );
                        t.$events.push(e)
                    }
            ...
            case "selector":
                {
                    const e = i(l, "click", async e => {
                        t.selector?.length ? this.render(t.selector) : (this.check(t),
                        t.$parent.onSelect && (t.$parent.tooltip = await t.$parent.onSelect.call(this.art, t, l, e)))
                    }
                    );
                    t.$events.push(e),
                    t.default && f(l, "art-current")
                }
                break;
            case "button":
                if (t.onClick) {
            ...
            e ? z(l, a) : y(r, l),
            t.mounted && setTimeout( () => t.mounted.call(this.art, t.$item, t), 0)
        }
        render(t=this.option) {
            ...
            this.cache.has(t)) {
                ...
                const e = L("div");
                this.cache.set(t, e),
                f(e, "art-setting-panel"),
                y(this.$parent, e),
                $(e, "art-current"),
                t[0]?.$parent && this.createHeader(t[0]);
    ...
    class jt extends dt {
        ...
        createTrack(t, e) {
            const {template: r, proxy: a, option: o} = this.art
              , {$video: n, $track: i} = r
              , s = L("track");
            s.default = !0,
            s.kind = t,
        ...
        async init(t) {
            ...
            return this.textTrack ? (o(t, ct.subtitle),
            t.url ? (this.option = t,
            this.style(t.style),
    ...
    class Ut {
        constructor(t) {
            ...
            e.container instanceof Element ? this.$container = e.container : (this.$container = u(e.container),
            _(this.$container, `No container element found by ${e.container}`)),
            _(I(), "The current browser does not support flex layout");
            const a = this.$container.tagName.toLowerCase();
            _("div" === a, `Unsupported container element type, only support 'div' but got '${a}'`),
            _(r.instances.every(t => t.template.$container !== this.$container), "Cannot mount multiple instances on the same dom element"),
        ...
        init() {
            ...
            t.proxy) {
                ...
                _(e instanceof HTMLVideoElement || e instanceof HTMLCanvasElement, "Function 'option.proxy' needs to return 'HTMLVideoElement' or 'HTMLCanvasElement'"),
                z(e, this.$video),
                e.className = "art-video",
                this.$video = e
            }
            t.backdrop && f(this.$player, "art-backdrop"),
            p && f(this.$player, "art-mobile")
        }
        destroy(t) {
        ...
        off(t, e) {
            ...
            if (a && e)
                for (let n = 0, i = a.length; n < i; n += 1)
                    a[n].fn !== e && a[n].fn._ !== e && o.push(a[n]);
    ...
    class Kt extends qt {
        constructor(t, e) {
            ...
            this.isRotate = !1,
            this.isDestroy = !1,
            this.template = new Ut(this),
            this.events = new vt(this),
            this.storage = new Ht(this),
            this.icons = new xt(this),
            this.i18n = new wt(this),
            this.notice = new Ct(this),
            this.player = new Ot(this),
            this.layers = new $t(this),
            this.controls = new ft(this),
            this.contextmenu = new pt(this),
            this.subtitle = new jt(this),
            this.info = new kt(this),
            this.loading = new Tt(this),
            this.hotkey = new yt(this),
            this.mask = new Et(this),
            this.setting = new Bt(this),
            this.plugins = new Ft(this),
            "function" === typeof e && this.on("ready", () => e.call(this, this)),
            Kt.DEBUG) {
                const t = t => console.log(`[ART.${this.id}] -> ${t}`);
                t(`Version@${Kt.version}`);
                for (let e = 0; e < i.events.length; e++)
                    this.on(`video:${i.events[e]}`, e => t(`Event@${e.type}`))
            }
            Gt.push(this)
        }
        ...
        destroy(t=!0) {
            Kt.REMOVE_SRC_WHEN_DESTROY && this.reset(),
            this.events.destroy(),
            this.template.destroy(t),
            Gt.splice(Gt.indexOf(this), 1),
            this.isDestroy = !0,
            this.emit("destroy")
        }
    }
    ...
    Kt.CONTEXTMENU = !0,
    Kt.NOTICE_TIME = 2e3,
    Kt.SETTING_WIDTH = 250,
    Kt.SETTING_ITEM_WIDTH = 200,
    Kt.SETTING_ITEM_HEIGHT = 35,
    Kt.RESIZE_TIME = 200,
    Kt.SCROLL_TIME = 200,
    Kt.SCROLL_GAP = 50,
    Kt.AUTO_PLAYBACK_MAX = 10,
    Kt.AUTO_PLAYBACK_MIN = 5,
    Kt.AUTO_PLAYBACK_TIMEOUT = 3e3,
    Kt.RECONNECT_TIME_MAX = 5,
    Kt.RECONNECT_SLEEP_TIME = 1e3,
    Kt.CONTROL_HIDE_TIME = 3e3,
    Kt.DBCLICK_TIME = 300,
    Kt.DBCLICK_FULLSCREEN = !0,
    Kt.MOBILE_DBCLICK_PLAY = !0,
    Kt.MOBILE_CLICK_PLAY = !1,
    Kt.AUTO_ORIENTATION_TIME = 200,
    Kt.INFO_LOOP_TIME = 1e3,
    Kt.FAST_FORWARD_VALUE = 3,
    Kt.FAST_FORWARD_TIME = 1e3,
    Kt.TOUCH_MOVE_RATIO = .5,
    Kt.VOLUME_STEP = .1,
    Kt.SEEK_STEP = 5,
    Kt.PLAYBACK_RATE = [.5, .75, 1, 1.25, 1.5, 2],
    Kt.ASPECT_RATIO = ["default", "4:3", "16:9"],
    Kt.FLIP = ["normal", "horizontal", "vertical"],
    Kt.FULLSCREEN_WEB_IN_BODY = !0,
    Kt.LOG_VERSION = !0,
    Kt.USE_RAF = !1,
    Kt.REMOVE_SRC_WHEN_DESTROY = !0,
    h && (M("artplayer-style", Wt),
    setTimeout( () => {
...
//
// 키를 누르는 동안:
//     실제 video.currentTime은 변경하지 않음
//     virtualTime만 변경
//
// 키를 놓으면:
//     실제 video.currentTime에 적용
//
// ArtPlayer 기존 하단 UI:
//     전부 숨김
//
...
(function () {
    ...
    if (window.__TV_VIRTUAL_SEEK__) {
        return;
    }

    window.__TV_VIRTUAL_SEEK__ = true;
    ...
    function hideArtPlayerBottomUI() {

        if (
            document.getElementById(
                "tv-hide-artplayer-bottom-ui"
            )
        ) {
            return;
        }
    ...
    function getUIParent() {
        ...
        if (
            window._art?.template?.$player
        ) {

            return window._art.template.$player;
    ...
    // KEY DOWN
    //
    // capture 단계에서 ArtPlayer보다 먼저 좌우 키를 가로챈다.
    // ============================================================
    ...
    // Fullscreen 변경 감지
    //
    // Fullscreen 진입/종료 시 UI의 부모를 다시 확인한다.
    // ============================================================
    ...
    // 초기화
    //
    // 기존 ArtPlayer 하단 UI를 숨긴다.
    // ============================================================

    hideArtPlayerBottomUI();
